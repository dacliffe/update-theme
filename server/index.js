...
// Handle Shopify app installation/access from admin
app.get('/shopify', (req, res) => {
  const { shop, host } = req.query;
  
  if (!shop) {
    return res.status(400).send('Missing shop parameter. Please access this app from your Shopify admin or use the installation URL.');
  }
